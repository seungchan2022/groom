...
// MARK: - DetailPage.ReservationCityItemComponent

extension DetailPage {
  struct ReservationCityItemComponent {
...
// MARK: - DetailPage.ReservationCityItemComponent + View

extension DetailPage.ReservationCityItemComponent: View {
  var body: some View {
    VStack(spacing: .zero) {
      Divider()
...
// MARK: - DetailPage.ReservationCityItemComponent.ViewState

extension DetailPage.ReservationCityItemComponent {
  struct ViewState: Equatable {
    let item: Airbnb.SearchCityDetail.Item
  }
}
