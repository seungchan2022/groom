...
// MARK: - DetailPage.SearchCountryResultComponent
...
extension DetailPage {
  struct SearchCountryResultComponent {
    ...
    let backAction: () -> Void
    let tapAction: () -> Void
    let likeAction: (Airbnb.SearchCountryDetail.Item) -> Void

    @Binding var position: MapCameraPosition
  }
}

extension DetailPage.SearchCountryResultComponent {
...
// MARK: - DetailPage.SearchCountryResultComponent + View

extension DetailPage.SearchCountryResultComponent: View {
  var body: some View {
    TabView {
...
// MARK: - DetailPage.SearchCountryResultComponent.ViewState
