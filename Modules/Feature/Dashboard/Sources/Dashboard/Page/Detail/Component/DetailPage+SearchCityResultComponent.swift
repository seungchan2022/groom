...
// MARK: - DetailPage.SearchCityResultComponent
...
extension DetailPage {
  struct SearchCityResultComponent {
    ...
    let backAction: () -> Void
    let tapAction: () -> Void
    let likeAction: (Airbnb.SearchCityDetail.Item) -> Void

    @Binding var position: MapCameraPosition
  }
}

extension DetailPage.SearchCityResultComponent {
...
// MARK: - DetailPage.SearchCityResultComponent + View

extension DetailPage.SearchCityResultComponent: View {
  var body: some View {
    TabView {
...
// MARK: - DetailPage.SearchCityResultComponent.ViewState
